...
public class Model extends BaseAdapter
{
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (Main3Activity.keys[position].getGraphic() != null)
            Glide.with(context).
                    load("https://raw.githubusercontent.com/wesleywerner/ancient-tech/02decf875616dd9692b31658d92e64a20d99f816/src/images/tech/" + Main3Activity.keys[position].getGraphic()).
                    into(graphic);
